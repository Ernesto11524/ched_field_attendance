    ...
    <div>
      <div className="page-header">
        <div>
          ...
          <p className="page-subtitle">{workers.length} active field workers</p>
        </div>
              ...
              {loading ? (
                ...
                <tr key={w.id}>
                  ...
                  <td>
                    ...
                    {w.email && <div style={{ fontSize: 12, color: 'var(--text-muted)' }}>{w.email}</div>}
                  </td>
                  ...
                  <td>
                    <div style={{ display: 'flex', gap: 8 }}>
                      <button className="btn btn-ghost btn-sm"
                        onClick={() => { setSelected(w); setModal('assign'); setError(''); }}>
                        Assign Site
                      </button>
        ...
        <div className="modal-overlay" onClick={e => e.target === e.currentTarget && setModal(null)}>
          <div className="modal">
            <div className="modal-header">
              <h3 style={{ fontFamily: 'var(--font-display)', fontWeight: 800, fontSize: 18 }}>Add New Worker</h3>
            ...
            <form onSubmit={handleCreate}>
              <div className="modal-body">
                ...
                <div className="input-group">
                  ...
                  <input className="input-field" required placeholder="Kofi Asante"
                    value={form.full_name} onChange={e => setForm({...form, full_name: e.target.value})} />
                </div>
                <div className="input-group">
                  <label className="input-label">Employee ID *</label>
                  <input className="input-field" required placeholder="EMP-011"
                    value={form.employee_id} onChange={e => setForm({...form, employee_id: e.target.value})} />
                </div>
                <div className="input-group">
                  <label className="input-label">Phone Number *</label>
                  <input className="input-field" required placeholder="+233241234567"
                    value={form.phone_number} onChange={e => setForm({...form, phone_number: e.target.value})} />
                </div>
                <div className="input-group">
                  <label className="input-label">Email (optional)</label>
                  <input className="input-field" type="email" placeholder="kofi@company.com"
              ...
              <div className="modal-footer">
                ...
                <button type="submit" className="btn btn-primary" disabled={saving}>
                  {saving ? <span className="spinner" /> : null} Add Worker
                </button>
              </div>
            </form>
          </div>
            ...
            <form onSubmit={handleAssign}>
              <div className="modal-body">
                ...
                <div className="input-group">
                  ...
                  <select className="input-field" required value={assignForm.site_id}
              ...
              <div className="modal-footer">
                <button type="button" className="btn btn-ghost" onClick={() => setModal(null)}>Cancel</button>
                <button type="submit" className="btn btn-primary" disabled={saving}>
                  {saving ? <span className="spinner" /> : null} Save Assignment
                </button>
              </div>
            </form>
          </div>
